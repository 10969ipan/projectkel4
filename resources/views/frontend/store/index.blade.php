        ...
        <div class="store-hero-card" style="background: linear-gradient(135deg, #0076D6 0%, #005FA3 100%); color: white; border-radius: 32px; padding: 60px 80px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 30px 60px rgba(0, 118, 214, 0.2); position: relative; overflow: hidden; min-height: 400px;">
            ...
            <div style="position: relative; z-index: 10; max-width: 600px;">
                ...
                <div class="store-hero-buttons" style="display: flex; gap: 20px; align-items: center;">
                    ...
                    <a href="#chat" onclick="toggleChat()" style="color: white; font-weight: 700; text-decoration: none; display: flex; align-items: center; gap: 10px; font-size: 1rem;" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.9'">
                        <div style="width: 48px; height: 48px; background: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; backdrop-filter: blur(5px);"><i class="fas fa-comment-dots" aria-hidden="true"></i></div>
                        Chat SIMA
                    </a>
                </div>
            </div>
        ...
        (function() {
            ...
            function initInfiniteCarousel() {
                ...
                const clonesBefore = cards.map(c => {
                    ...
                    // Prevent focus inside hidden clones
                ...
                <div style="max-width: 580px; color: white; text-shadow: 0 2px 10px rgba(0,0,0,0.3);">
                    ...
                    <a href="#wellness" onclick="window.openArticleModal(window._wellnessArticles[{{ $index }}])"
                       ...
                       onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 15px 30px rgba(0,0,0,0.25)'">
                        Baca Selengkapnya <i class="fas fa-arrow-right" style="font-size: 0.85rem; color: var(--primary-blue);" aria-hidden="true"></i>
                    </a>
                </div>
            </div>
            @endforeach
