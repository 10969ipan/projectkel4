...
<head>
    ...
    <title>Lupa Password - Pharmacare</title>
...
<body>
    ...
    <div class="auth-card">
        <a href="{{ route('store.login') }}" class="back-link">
        ...
        <div class="form-header">
            <h1>Lupa Password?</h1>
            <p>Masukkan nomor WhatsApp Anda yang terdaftar. Kami akan mengirimkan kode OTP untuk mengatur ulang password Anda.</p>
        </div>

        <form action="{{ route('store.password.email') }}" method="POST">
            @csrf
            
            <div class="form-group">
                <label class="form-label" for="phone">Nomor WhatsApp</label>
                <input type="text" id="phone" name="phone" class="form-control" value="{{ old('phone') }}" placeholder="Contoh: 081234567890" required autofocus>
            </div>
