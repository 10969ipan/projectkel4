                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="item-info">
                                    <div class="item-icon">
                                        {{ $cartItem['requires_prescription'] ? '⚕️' : '💊' }}
                                    </div>
                                    <div>
                            ...
                            <td>
                                <form action="{{ route('cart.update', $cartItem['id']) }}" method="POST" style="display:flex; align-items: center; gap: 10px;">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <button type="submit" style="background: #E6F3FF; border: none; padding: 8px 14px; border-radius: 8px; color: var(--primary-blue); font-weight: 600; cursor: pointer; font-size: 0.9rem;">Update</button>
                                </form>
                            </td>
