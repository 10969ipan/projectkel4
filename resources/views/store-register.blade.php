    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', 'Segoe UI', Arial, sans-serif; }
        ...
        @media (max-width: 550px) {
            .auth-card { padding: 40px 20px; border-radius: 0; border: none; box-shadow: none; background: transparent; }
...
<body>
    ...
    <div class="auth-card">
        ...
        <div class="form-header">
            <h1>Daftar Akun</h1>
            <p>Bergabung dan nikmati kemudahan belanja obat.</p>
        </div>
        ...
        <form action="{{ route('store.register.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="Irfan Arfian" value="{{ old('name') }}" required>
            </div>
        ...
        <div class="auth-footer">
            Sudah punya akun? <a href="{{ route('store.login') }}">Login Sekarang</a>
        </div>
    </div>
