        ...
        <div class="p-8">
            <form action="{{ route('items.store') }}" method="POST" id="itemForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="md:col-span-2 bg-primary-50/50 p-6 rounded-xl border border-primary-100">
                        <div class="flex justify-between items-center mb-6">
                            <div>
                                ...
                                <p class="text-xs text-primary-600 font-medium">Daftarkan nomor batch dan masa kadaluwarsa untuk kontrol kualitas.</p>
                            </div>
                            <div class="bg-white px-4 py-2 rounded-lg border border-primary-200 shadow-sm">
                                <span class="block text-[10px] uppercase font-bold text-gray-400 leading-none mb-1">Total Persediaan</span>
                                <span class="text-2xl font-black text-primary-600 leading-none" id="displayTotalStock">0</span>
                            </div>
                        </div>
                            ...
                            <table class="min-w-full divide-y divide-primary-100" id="variantTable">
                                <thead class="bg-primary-50/30">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3 text-left text-xs font-bold text-primary-700 uppercase tracking-wider">Stok Awal</th>
                        ...
                        <button type="button" onclick="addBatchRow()"
                            ...
                            <i class="fas fa-plus-circle mr-2"></i> Tambah Batch Produk
                        </button>
                    </div>
                    ...
                    <div>
                        <label for="price" class="block text-sm font-semibold text-gray-700 mb-2">Harga Per Satuan (Rp)</label>
                    ...
                    {{-- Deskripsi --}}
                    <div class="md:col-span-2">
                        <label for="description" class="block text-sm font-semibold text-gray-700 mb-2">Catatan Tambahan / Indikasi</label>
                        <textarea name="description" id="description" rows="3"
                            placeholder="Tuliskan indikasi, dosis, atau informasi penting lainnya..."
                            class="block w-full px-4 py-3 rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border transition-all">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1.5 text-xs text-red-600 font-medium">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2 flex justify-end gap-3 pt-6 border-t border-gray-100">
                        <button type="submit"
                            ...
                            <i class="fas fa-save mr-2"></i> Simpan Data Produk
                        </button>
                    </div>
                </div>
            </form>
